import type { PrivacyPolicyContentProps } from "../types/privacy-policy.types";
            ...
            <aside className="hidden lg:block">
              <div className="sticky top-[calc(var(--site-header-height)+32px)]">
                <span className="flex size-12 items-center justify-center bg-[#EAF7FC] text-[#0077B6]">
                  <PrivacyPolicyIcon name="shield" className="size-5" />
                </span>
            ...
            <div className="min-w-0">
                          ...
                          {section.items.map((item) => (
                            <li key={item} className="list-none">
                              <div className="flex items-start gap-4">
                                <span className="mt-[10px] size-2 shrink-0 bg-[#00A4E4]" />
              ...
              <div className="mt-12 border-t-[3px] border-[#00A4E4] bg-[#F5FAFC] px-6 py-7 sm:px-8">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  >
                    <PrivacyPolicyIcon name="mail" className="size-[17px]" />
                    contact@royalprima.com
                    <PrivacyPolicyIcon name="arrow" className="size-[16px]" />
                  </a>
                </div>
              </div>
            </div>
