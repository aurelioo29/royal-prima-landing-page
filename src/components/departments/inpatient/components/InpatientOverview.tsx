import type { InpatientOverviewProps } from "../types/inpatient.types";

export default function InpatientOverview({
  eyebrow,
  title,
  description,
  stats,
        ...
        <div className="border-t border-[#DCEAF1]">
          {stats.map((stat) => (
            <div
              ...
              className="grid grid-cols-[130px_minmax(0,1fr)] items-center gap-4 border-b border-[#DCEAF1] py-5"
            >
              <strong className="text-[24px] font-bold tracking-[-0.03em] text-[#0077B6]">
                {stat.value}
              </strong>
