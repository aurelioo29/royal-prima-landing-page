...
export default function InpatientInfo({
  eyebrow,
  title,
  description,
  roomLabel,
    ...
    >
      <div className="mx-auto grid w-full max-w-[1760px] grid-cols-1 gap-12 px-5 sm:px-8 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20 lg:px-10 xl:px-12 2xl:px-16">
        ...
        <div className="border-t border-[#D7E7EE]">
          <InfoRow icon="rooms" label={roomLabel} value={roomValue} />

          <InfoRow icon="payment" label={patientLabel} value={patientValue} />
          ...
          <div className="grid grid-cols-[48px_minmax(0,1fr)] gap-5 border-b border-[#D7E7EE] py-6 sm:grid-cols-[54px_180px_minmax(0,1fr)_auto] sm:items-center">
            <span className="flex size-11 items-center justify-center bg-white text-[#0077B6]">
              <InpatientIcon name="phone" className="size-5" />
            </span>
            ...
            <a
              href={phoneHref}
              className="col-start-2 inline-flex w-fit items-center gap-3 bg-[#0077B6] px-5 py-3 text-sm font-semibold text-white! no-underline! transition-colors duration-300 hover:bg-[#00669D] sm:col-start-auto"
            >
              {contactLabel}

              <InpatientIcon name="arrow" className="size-4" />
            </a>
          </div>
        </div>
      </div>
...
function InfoRow({
  ...
  return (
    <div className="grid grid-cols-[48px_minmax(0,1fr)] gap-5 border-b border-[#D7E7EE] py-6 sm:grid-cols-[54px_180px_minmax(0,1fr)] sm:items-center">
      <span className="flex size-11 items-center justify-center bg-white text-[#0077B6]">
        <InpatientIcon name={icon} className="size-5" />
      </span>
