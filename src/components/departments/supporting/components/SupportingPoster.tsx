...
import type { SupportingPosterProps } from "../types/supporting.types";

import SupportingIcon from "./SupportingIcon";

export default function SupportingPoster({
  image,
  imageAlt,
  eyebrow,
  title,
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="mx-auto w-full max-w-[1760px] px-5 sm:px-8 lg:px-10 xl:px-12 2xl:px-16">
        <article className="relative min-h-[480px] overflow-hidden bg-[#123B56]">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,43,65,0.97)_0%,rgba(8,43,65,0.90)_32%,rgba(8,43,65,0.70)_51%,rgba(8,43,65,0.16)_78%,rgba(8,43,65,0.02)_100%)]" />
          ...
          <div className="relative z-10 flex min-h-[480px] items-center px-7 py-14 sm:px-10 lg:px-16 xl:px-20">
            <div className="max-w-[700px]">
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                ...
                >
                  <SupportingIcon name="phone" className="size-[18px]" />
                ...
                >
                  <SupportingIcon name="doctor" className="size-[18px]" />
