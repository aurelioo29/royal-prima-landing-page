...
import type { SupportingRelatedDepartmentsProps } from "../types/supporting.types";

import SupportingIcon from "./SupportingIcon";

export default function SupportingRelatedDepartments({
  eyebrow,
  title,
  description,
  viewLabel,
  items,
}: SupportingRelatedDepartmentsProps) {
  return (
            ...
            >
              <div className="flex items-end justify-between gap-6">
                ...
                <span className="flex size-10 shrink-0 items-center justify-center bg-white text-[#0077B6] transition-colors group-hover:bg-[#0077B6] group-hover:text-white">
                  <SupportingIcon name="arrow" className="size-[17px]" />
                </span>
              </div>
